...
public class AsteroidSpawner : MonoBehaviour 
{
    ...
    void SpawnAsteroid()
    {
        if(GameManager.SharedInstance.AsteroidThreatList!=null)
        {
            ...
            GameObject newAsteroidThreat = Instantiate(asteroidClone, (Vector2)transform.position + insideUnitCircle * (GameManager.SharedInstance.CurrentSolarSystemSeed.SolarSystemRadius + distanceFromSolarSystemBoundary), Quaternion.identity) as GameObject;
